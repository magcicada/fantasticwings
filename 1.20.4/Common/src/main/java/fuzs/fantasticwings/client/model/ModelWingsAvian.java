...
public final class ModelWingsAvian extends ModelWings<AnimatorAvian> {
    ...
    public ModelWingsAvian() {
        ...
        this.feathersLeft = ImmutableList.of(feathersCoracoidLeft,
                feathersTertiaryLeft,
                feathersSecondaryLeft,
                feathersPrimaryLeft
        );
        this.feathersRight = ImmutableList.of(feathersCoracoidRight,
                feathersTertiaryRight,
                feathersSecondaryRight,
                feathersPrimaryRight
        );
    }
    ...
    private static void add3DTexture(ModelPart model, int u, int v, float offX, float offY, float offZ, int width, int height) {
        model.cubes.add(Model3DTexture.create(offX, offY, offZ, width, height, u, v, 64, 64));
    }
}
